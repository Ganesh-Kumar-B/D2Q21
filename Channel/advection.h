...
void inlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q21<T1> &lbD3Q13, double ux, double uy,double rho){


double feq_Node[lbgrid.d_v] = {0},feq_Cell[lbgrid.d_v] = {0};
...
template<typename T, typename T1>
void outlet(Grid_N_C_2D<T> &lbgrid,lbmD2Q21<T1> &lbD3Q13, double ux, double uy,double rho){
