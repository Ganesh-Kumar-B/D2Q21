...
myreal p1=64575;//Right side or Low Pressure or PRESSURE TO THE RIGHT OF THE SHOCK
myreal p4=129150;//Left side or High Pressure
...
myreal t=0.08;//time in milliseconds
...
ofstream myfile("properties.dat");
myfile << 0 << " " << f.u4 << " "<< f.a4 <<  " "<< f.p4 << " " << f.rho4 << endl;
myfile << x43 << " " << f.u4 << " "<< f.a4 <<  " "<< f.p4 << " " << f.rho4 << endl;
...
myreal x=temp+f.l/2;
myfile << x << " "<<  u[i]<< " "<< a[i]<< " "<< p[i]<< " "<<  rho[i] << endl;

}

myfile << x22dash << " "<<  u2 << " "<< a2dash << " "<< p2 << " "<<rho2dash << endl;
myfile << x22dash << " "<<  u2 << " "<< a2 << " "<< p2 << " "<< rho2 << endl;
myfile << x21 << " "<<  u2 << " "<< a2 << " "<< p2 << " "<< rho2 << endl;
myfile << x21 << " " << f.u1 << " "<< f.a1 <<  " "<< f.p1 << " " << f.rho1 << endl;
myfile << f.l << " " << f.u1 << " "<< f.a1 <<  " "<< f.p1 << " " << f.rho1 << endl;
